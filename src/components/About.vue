    ...
    <div id="about">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="column">
                    <p>
                        Being a product-minded developer I am curious about seeking to understand the project in order to see all the options and edge cases before writing any code. From mock ups to architecture I like organized and consistent structure that won't make a user second guess what to do next. I find there are always ways to speed things up and do regular refactors as I learn and grow.
                    </p>
                    <p>
