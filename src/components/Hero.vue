<template>
  <div id="hero" class="sherbert">
    <div class="container">
        ...
        <h1 class="animated fadeIn delay1">Hi there, my name is Sarah Dulat and I am a front end developer at <a href="http://www.reorg-research.com" target="_blank">Reorg</a> in NYC (<a href="https://jobs.lever.co/reorgresearch?lever-via=gozPBhAQBk" target="_blank">we're hiring!</a>).</h1>
